...
import Actions.DeleteUnSchORLtActions;

public class DeleteUnSchORLtChecklist extends Baseclass {
	

	
	@Test
	public void DeleteUnSchORLtChecklist() throws InterruptedException
	{
		try {
            ...
            Thread.sleep(3000);
            System.out.println("Checklist delete action cancelled");
            ...
            Thread.sleep(3000);
            System.out.println("Click on delete button");
            driver.findElement(By.xpath("//div[@id='deleteChecklistDialog']/div[@class='pt-dialog-content-placeholder']/div/div[2]/button[2]//span[@class='pt-text']")).click();
            Thread.sleep(3000);
